...
export const DICT: Record<Lang, Record<string, string>> = {
  en: {
    ...
    inventoryItemText: "Inventory item",
    inventoryItemDescription: "Description",
    inventoryItemDescriptionTitle: "Inventory item description",
    close: "Close",
  ...
  ru: {
    ...
    inventoryItemText: "Предмет инвентаря",
    inventoryItemDescription: "Описание",
    inventoryItemDescriptionTitle: "Описание предмета инвентаря",
    close: "Закрыть",
